...
ManufacturingNet.shallow_learning_methods' **AllRegressionModels** class trains the following models on your dataset with default parameters:
...
.. code-block:: python
    ...
    from ManufacturingNet.shallow_learning_methods import AllRegressionModels
